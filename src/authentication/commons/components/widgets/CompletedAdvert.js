...
import {Button, Chip, Container, Divider, Grid, Typography} from "@material-ui/core";
...
class CompletedAdvert extends Component {
    constructor() {
        super();
    }
...
export default connect(null,{showMainDialog})(
    withStyles(userStyle)(CompletedAdvert)
);